export const researchData = {
  ...
  conclusion: 'This study identified a pattern of low postural awareness alongside a high prevalence of back pain among Suez University students, with most participants reporting moderate to severe pain intensity. A significant inverse association was found between postural awareness and back pain severity, indicating that students with lower levels of postural awareness were more likely to experience higher pain intensity, whereas those with higher awareness reported lower levels of pain. These findings suggest that postural awareness may play an important role in the occurrence and severity of back pain among university students. Therefore, interventions aimed at improving postural awareness and promoting healthy postural behaviors may represent practical and effective strategies for reducing the prevalence and severity of back pain in this population.',
